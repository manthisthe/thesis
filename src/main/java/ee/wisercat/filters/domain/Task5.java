...
public class Task5 implements Serializable {
    ...
    public Task5 participantName(String participantName) {
    ...
    public Task5 taskCompletionTimeSeconds(Integer taskCompletionTimeSeconds) {
    ...
    public Task5 errors(Integer errors) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((Task5) o).getId());
    }
