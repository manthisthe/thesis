...
public class Task3 implements Serializable {
    ...
    public Task3 participantName(String participantName) {
    ...
    public Task3 taskCompletionTimeSeconds(Integer taskCompletionTimeSeconds) {
    ...
    public Task3 errors(Integer errors) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Task3)) {
            return false;
        }
        return getId() != null && getId().equals(((Task3) o).getId());
    }
