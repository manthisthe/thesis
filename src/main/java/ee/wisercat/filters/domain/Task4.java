...
public class Task4 implements Serializable {
    ...
    public Task4 participantName(String participantName) {
    ...
    public Task4 taskCompletionTimeSeconds(Integer taskCompletionTimeSeconds) {
    ...
    public Task4 errors(Integer errors) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Task4)) {
            return false;
        }
        return getId() != null && getId().equals(((Task4) o).getId());
    }
